  ...
  45                     ; 9 void Serial_Init(void){
  47                     	switch	.text
  48  0000               _Serial_Init:
  52                     ; 10     UART3_DeInit();
  54  0000 cd0000        	call	_UART3_DeInit
  56                     ; 12 	UART3_Init((uint32_t)SERIAL_BAUDRATE, 
  56                     ; 13             SERIAL_DATA_BITS, 
  56                     ; 14             SERIAL_STOP_BIT, 
  56                     ; 15             SERIAL_PARITY,
  56                     ; 16             UART3_MODE_TXRX_ENABLE);
  ...
  69                     ; 17 	UART3_Cmd(ENABLE);
  71  0018 a601          	ld	a,#1
  72  001a cd0000        	call	_UART3_Cmd
  74                     ; 18 }
  77  001d 81            	ret
 123                     ; 30 void Serial_Print(char string[]) {
 124                     	switch	.text
 ...
 138  0024               L34:
 139                     ; 33         UART3_SendData8(string[i]);
 ...
 149  002f               L55:
 150                     ; 34         while (UART3_GetFlagStatus(UART3_FLAG_TXE) == RESET);
